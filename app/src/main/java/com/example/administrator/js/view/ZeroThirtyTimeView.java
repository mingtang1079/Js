...
public class ZeroThirtyTimeView extends LinearLayout implements NumberPickerView.OnValueChangeListener {
    ...
    public ZeroThirtyTimeView(Context context) {
        super(context);
        initInternal(context);
    }

    public ZeroThirtyTimeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initInternal(context);
        initAttr(context, attrs);
    }

    public ZeroThirtyTimeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initInternal(Context context) {
        View contentView = inflate(context, R.layout.view_two_date_time, this);
